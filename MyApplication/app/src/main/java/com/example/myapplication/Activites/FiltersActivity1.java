...
public class FiltersActivity1 extends AppCompatActivity {
    ...
    private void init(){
        ...
        mSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(FiltersActivity1.this);
